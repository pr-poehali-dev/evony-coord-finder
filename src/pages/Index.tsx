          ...
          name:
            type === "monsters"
              ...
              : type === "castles"
                ...
                : "Золотые залежи",
          coordinates: "245,678",
          level: type === "monsters" ? 15 : type === "castles" ? 25 : 8,
        },
        {
          id: 2,
          name:
            type === "monsters"
              ...
              : type === "castles"
                ...
                : "Железная руда",
          coordinates: "189,432",
          level: type === "monsters" ? 20 : type === "castles" ? 30 : 12,
        },
        {
          id: 3,
          name:
            type === "monsters"
              ...
              : type === "castles"
                ...
                : "Серебряные жилы",
          coordinates: "567,234",
          level: type === "monsters" ? 18 : type === "castles" ? 22 : 10,
        },
      ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-evony-dark via-evony-purple to-evony-dark text-white">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-evony-purple/80 to-evony-dark/80 backdrop-blur-sm">
        <div className="absolute inset-0 opacity-20 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.05)_1px,transparent_1px)] bg-[length:30px_30px]"></div>
        <div className="relative container mx-auto px-4 py-16 text-center">
          <div className="mb-6">
            <Icon
              name="Target"
              size={64}
              className="mx-auto mb-4 text-evony-orange"
            />
          </div>
          ...
          <p className="font-roboto text-lg text-gray-300 max-w-2xl mx-auto">
            Найдите координаты монстров, вражеских замков и залежей ресурсов в
            игре Evony. Просто введите номер сервера и начните поиск.
          </p>
        </div>
      </div>
            ...
            <CardContent>
              <div className="flex gap-4 mb-6">
                <div className="flex-1">
                  <Label
                    htmlFor="server"
                    className="text-gray-300 mb-2 block font-roboto"
                  >
                    Номер сервера
                  </Label>
                  <Input
              ...
              <Tabs defaultValue="monsters" className="w-full">
                <TabsList className="grid w-full grid-cols-3 bg-gray-800 border-gray-600">
                  <TabsTrigger
                    value="monsters"
                    className="data-[state=active]:bg-evony-orange data-[state=active]:text-white"
                  >
                  ...
                  {searchResults.map((result) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        <Badge
                          variant="secondary"
                          className="bg-evony-orange text-white font-mono text-lg px-3 py-1"
                        >
                          {result.coordinates}
                        </Badge>
                      </div>
      ...
      <div className="mt-16 bg-gray-900/50 border-t border-gray-700 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-8 text-center">
          <p className="text-gray-400 font-roboto">
            🚀 Сделано с помощью{" "}
            <span className="text-evony-orange font-semibold">Поехали!</span>
          </p>
        </div>
      </div>
    </div>
